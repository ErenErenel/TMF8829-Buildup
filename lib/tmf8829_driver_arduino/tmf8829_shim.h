...
/** @file This is the shim for the arduino uno, adapted for the
 * NUCLEO-H563ZI + LightRanger 14 Click (TMF8829-Buildup project).
...
#define TRIGGER_INTERRUPT_PIN                 PE11  /**< same physical pin as INTERRUPT_PIN -- only one TMF8829 on this bus */
